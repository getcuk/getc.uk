...
Harvard’s free [CS50](https://www.edx.org/learn/computer-science/harvard-university-cs50-s-introduction-to-computer-science) course is a rigorous companion if you want lectures and problem sets alongside. Here on getc.uk we walk the same ground one step at a time — beginning with the tool you will use every day: the [command line](/lessons/command-line).
